...
The sources for dotty_dict can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/pawelzny/dotty_dict
.. _tarball: https://github.com/pawelzny/dotty_dict/tarball/master
